...
export const CHAPTER_II = 'Art. 11.  A responsabilidade técnica pela alimentação escolar nos Estados, no Distrito Federal, nos Municípios e nas escolas federais caberá ao nutricionista responsável, que deverá respeitar as diretrizes previstas nesta Lei e na legislação pertinente, no que couber, dentro das suas atribuições específicas. \n '
                         ...
                         + '\n§ 1º  Para efeito desta Lei, gêneros alimentícios básicos são aqueles indispensáveis à promoção de uma alimentação saudável, observada a regulamentação aplicável.  (Renumerado do parágrafo único Incluído pela Lei nº 12.982, de 2014)\n '
...
export const CHAPTER_III = 'Art. 21.  Ocorrendo a suspensão prevista no art. 20, fica o FNDE autorizado a realizar, em conta específica, o repasse dos recursos equivalentes, pelo prazo de 180 (cento e oitenta) dias, diretamente às unidades executoras, conforme previsto no art. 6o desta Lei, correspondentes às escolas atingidas, para fornecimento da alimentação escolar, dispensando-se o procedimento licitatório para aquisição emergencial dos gêneros alimentícios, mantidas as demais regras estabelecidas para execução do PNAE, inclusive quanto à prestação de contas. \n '
                       ...
                       + '\n§ 1o  A assistência financeira a ser concedida a cada estabelecimento de ensino beneficiário e aos polos presenciais da UAB que ofertem programas de formação inicial ou continuada a profissionais da educação básica será definida anualmente e terá como base o número de alunos matriculados na educação básica e na UAB, de acordo, respectivamente, com dados do censo escolar realizado pelo Ministério da Educação e com dados coletados pela Coordenação de Aperfeiçoamento de Pessoal de Ensino Superior - CAPES, observado o disposto no art. 24.  (Redação dada pela Lei nº 12.695, de 2012)\n '
                       ...
                       + '\n§ 1o  As prestações de contas dos recursos transferidos para atendimento das escolas e dos polos presenciais do sistema UAB que não possuem unidades executoras próprias deverão ser feitas ao FNDE, observadas as respectivas redes de ensino, pelos Municípios e pelas Secretarias de Educação dos Estados e do Distrito Federal. (Redação dada pela Lei nº 12.695, de 2012)\n '
                       ...
                       + '\n§ 3o  Em caso de omissão no encaminhamento das prestações de contas, na forma do inciso I do caput, fica o FNDE autorizado a suspender o repasse dos recursos a todas as escolas e polos presenciais do sistema UAB da rede de ensino do respectivo ente federado. (Redação dada pela Lei nº 12.695, de 2012)\n '
                       ...
                       + '\n___________________________________________________________________________________” (NR) \n '
                       ...
                       + '\n§ 2o  Os valores e os critérios para concessão e manutenção das bolsas serão fixados pelo Poder Executivo. (Incluído pela Lei nº 12.695, de 2012)\n '
