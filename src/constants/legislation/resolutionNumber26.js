...
export const CHAPTER_V = 'DAS AÇÕES DE EDUCAÇÃO ALIMENTAR E NUTRICIONAL E DE SEGURANÇA ALIMENTAR E NUTRICIONAL\n '
                         + '\nArt. 12 A coordenação das ações de alimentação escolar, sob a responsabilidade dos Estados, do Distrito Federal e dos Municípios e das escolas federais, será realizada por nutricionista habilitado, que deverá assumir a responsabilidade técnica do Programa, respeitando as diretrizes previstas na Lei nº 11.947/2009 e em legislações específicas, dentro de suas atribuições.\n '
...
export const CHAPTER_VI = 'DA AQUISIÇÃO DE GÊNEROS ALIMENTÍCIOS\n '
                          ...
                          + '\n§3º O disposto neste artigo deverá ser observado nas aquisições efetuadas pelas UEx. das escolas de educação básica públicas de que trata o art. 6º da Lei nº 11.947/2009.\n '
                          + '\nArt.25 Para seleção, os projetos de venda habilitados serão divididos em: grupo de projetos de fornecedores locais, grupo de projetos do território rural, grupo de projetos do estado, e grupo de propostas do País. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nI - (Suprimido pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nII - (Suprimido pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nIII - (Suprimido pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nIV - (Suprimido pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nV - (Suprimido pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§ 1º - Entre os grupos de projetos, será observada a seguinte ordem de prioridade para seleção: (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nI - o grupo de projetos de fornecedores locais terá prioridade sobre os demais grupos. (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\nII - o grupo de projetos de fornecedores do território rural terá prioridade sobre o do estado e do País. (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\nIII - o grupo de projetos do estado terá prioridade sobre o do País. (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n§ 2º - Em cada grupo de projetos, será observada a seguinte ordem de prioridade para seleção: (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nI - os assentamentos de reforma agrária, as comunidades tradicionais indígenas e as comunidades quilombolas, não havendo prioridade entre estes; (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\nII - os fornecedores de gêneros alimentícios certificados como orgânicos ou agroecológicos, segundo a Lei nº 10.831, de 23 de dezembro de 2003; (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          ...
                          + '\n§3º Caso a EEx. não obtenha as quantidades necessárias de produtos oriundos do grupo de projetos de fornecedores locais, estas deverão ser complementadas com os projetos dos demais grupos, de acordo com os critérios de seleção e priorização estabelecidos no caput e nos §1º e §2º. (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n§4º Para efeitos do disposto neste artigo, serão considerados Grupos Formais e Grupos Informais de assentamentos da reforma agrária, comunidades quilombolas e/ou indígenas aqueles em que a composição seja de, no mínimo, 50% 1 (cinquenta por cento mais um) dos associados/cooperados das organizações produtivas, no caso do grupo formal, e 50% 1 (cinquenta por cento mais um) dos fornecedores agricultores familiares, no caso de grupo informal, conforme identificação na(s) DAP(s). (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n§5º No caso de empate entre Grupos Formais de assentamentos da reforma agrária, comunidades quilombolas e/ou indígenas, em referência ao disposto no §2º inciso I deste artigo, terão prioridade organizações produtivas com maior porcentagem de assentados da reforma agrária, quilombolas ou indígenas no seu quadro de associados/cooperados. Para empate entre Grupos Informais, terão prioridade os grupos com maior porcentagem de fornecedores assentados da reforma agrária, quilombolas ou indígenas -, conforme identificação na(s) DAP(s). (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n§6º No caso de empate entre Grupos Formais, em referência ao disposto no §2º inciso III deste artigo, terão prioridade organizações produtivas com maior porcentagem de agricultores familiares e/ou empreendedores familiares rurais no seu quadro de associados/ cooperados, conforme DAP Jurídica. (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n§7º Em caso de persistência de empate, será realizado sorteio ou, em havendo consenso entre as partes, poderá optar-se pela divisão no fornecimento dos produtos a serem adquiridos entre as organizações finalistas. (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\nArt. 26 As EEx. deverão publicar os editais de chamada pública para aquisição de gêneros alimentícios para a alimentação escolar em jornal de circulação local e na forma de mural em local público de ampla circulação, divulgar em seu endereço na internet, caso haja, e divulgar para organizações locais da agricultura familiar e para entidades de assistência técnica e extensão rural do município ou do estado. Se necessário, publique-se em jornal de circulação regional, estadual ou nacional e em rádios locais. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§1º Os editais das chamadas públicas deverão permanecer abertos para recebimento dos projetos de venda por um período mínimo de 20 dias. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§2º Os gêneros alimentícios a serem entregues ao contratante serão os definidos na chamada pública de compra, podendo ser substituídos quando ocorrer a necessidade, desde que os produtos substitutos constem na mesma chamada pública e sejam correlatos nutricionalmente e que a substituição seja atestada pelo RT, que poderá contar com o respaldo do CAE. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nArt. 27 Para a habilitação dos projetos de venda exigir-seá: (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§1º Dos Fornecedores Individuais, detentores de DAP Física, não organizados em grupo: (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nI - a prova de inscrição no Cadastro de Pessoa Física - CPF; (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nII - o extrato da DAP Física do agricultor familiar participante, emitido nos últimos 60 dias; (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nIII - o Projeto de Venda de Gêneros Alimentícios da Agricultura Familiar e/ou Empreendedor Familiar Rural para Alimentação Escolar com assinatura do agricultor participante (Anexo IV); (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nIV - a prova de atendimento de requisitos previstos em lei específica, quando for o caso; e (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nV - a declaração de que os gêneros alimentícios a serem entregues são oriundos de produção própria, relacionada no projeto de venda. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§2º Dos Grupos Informais de agricultores familiares, detentores de DAP Física, organizados em grupo: (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nI - a prova de inscrição no Cadastro de Pessoa Física - CPF; (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nII - o extrato da DAP Física de cada agricultor familiar participante, emitido nos últimos 60 dias; (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nIII - o Projeto de Venda de Gêneros Alimentícios da Agricultura Familiar e/ou Empreendedor Familiar Rural para Alimentação Escolar com assinatura de todos os agricultores participantes; (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nIV - a prova de atendimento de requisitos previstos em lei específica, quando for o caso; e (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nV - a declaração de que os gêneros alimentícios a serem entregues são produzidos pelos agricultores familiares relacionados no projeto de venda. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§3º Dos Grupos Formais, detentores de DAP Jurídica: (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nI - a prova de inscrição no Cadastro Nacional de Pessoa Jurídica - CNPJ; (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nII - o extrato da DAP Jurídica para associações e cooperativas, emitido nos últimos 60 dias; (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nIII - a prova de regularidade com a Fazenda Federal, relativa à Seguridade Social e ao Fundo de Garantia por Tempo de Serviço - FGTS; (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nIV - as cópias do estatuto e ata de posse da atual diretoria da entidade registrada no órgão competente; (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nV - o Projeto de Venda de Gêneros Alimentícios da Agricultura Familiar para Alimentação Escolar, assinado pelo seu representante legal; (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\nVI - a declaração de que os gêneros alimentícios a serem entregues são produzidos pelos associados/cooperados; e (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nVII - a declaração do seu representante legal de responsabilidade pelo controle do atendimento do limite individual de venda de seus cooperados/associados; e (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nVIII - a prova de atendimento de requisitos previstos em lei específica, quando for o caso. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§4º Na ausência ou desconformidade de qualquer desses documentos, fica facultado à EEx. a abertura de prazo para a regularização da documentação. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§5º (Suprimido pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          ...
                          + '\nArt. 29 O preço de aquisição dos gêneros alimentícios será determinado pela EEx., com base na realização de pesquisa de preços de mercado. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§1º O preço de aquisição será o preço médio pesquisado por, no mínimo, três mercados em âmbito local, priorizando a feira do produtor da agricultura familiar, quando houver, acrescido dos insumos exigidos no edital de chamada pública, tais como despesas com frete, embalagens, encargos e quaisquer outros necessários para o fornecimento do produto. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§2º Na impossibilidade da pesquisa ser realizada em âmbito local, deverá ser realizada ou complementada em âmbito territorial, estadual ou nacional, nessa ordem. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§3º: Os preços de aquisição definidos pela EEx. deverão constar na chamada pública, e serão os preços pagos ao agricultor familiar, empreendedor familiar rural e/ou suas organizações pela venda do gênero alimentício. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§4º Na impossibilidade de realização de pesquisa de preços de produtos agroecológicos ou orgânicos, a EEx. poderá acrescer aos preços desses produtos em até 30% (trinta por cento) em relação aos preços estabelecidos para produtos convencionais, conforme Lei nº 12.512, de 14 de outubro de 2011. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\n§5º O projeto de venda a ser contratado deverá ser selecionado conforme os critérios estabelecidos pelo art. 25. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          ...
                          + '\nArt. 30 Nos Estados, Distrito Federal, Municípios e escolas federais onde o valor total de repasse do FNDE para execução do PNAE seja superior a R$ 700.000,00 (setecentos mil reais) por ano, a EEx. poderá optar por aceitar propostas apenas de organizações com DAP Jurídica, desde que previsto na chamada pública.\n '
                          + '\nArt. 31 Os projetos de venda selecionados resultarão na celebração de contratos com a EEx., os quais deverão estabelecer os direitos, obrigações e responsabilidades das partes, em conformidade com os termos da chamada pública. (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nArt. 32 O limite individual de venda do agricultor familiar e do empreendedor familiar rural para a alimentação escolar deverá respeitar o valor máximo de R$ 20.000,00 (vinte mil reais), por DAP Familiar /ano/entidade executora, e obedecerá as seguintes regras: (Redação dada pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n_____________________________________________________________________  Redações Anteriores\n '
                          + '\nI - Para a comercialização com fornecedores individuais e grupos informais, os contratos individuais firmados deverão respeitar o valor máximo de R$ 20.000,00 (vinte mil reais), por DAP Familiar /ano/EEx. (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\nII - Para a comercialização com grupos formais o montante máximo a ser contratado será o resultado do número de agricultores familiares, munidos de DAP Familiar, inscritos na DAP Jurídica multiplicado pelo limite individual de comercialização, utilizando a seguinte fórmula: (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\nValor máximo a ser contratado = nº de agricultores familiares (DAPs familiares) inscritos na DAP jurídica x R$ 20.000,00.\n '
                          + '\n§1º Cabe às cooperativas e/ou associações que firmarem contratos com a EEx. a responsabilidade pelo controle do atendimento do limite individual de venda nos casos de comercialização com os grupos formais. (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\n§2º Cabe às EEx. a responsabilidade pelo controle do atendimento do limite individual de venda nos casos de comercialização com os grupos informais e agricultores individuais. A estas também compete o controle do limite total de venda das cooperativas e associações nos casos de comercialização com grupos formais. (Acrescentado pela Resolução 4/2015/CD/FNDE/MEC)\n '
                          + '\nSeção III\n '
...
export const CHAPTER_VII = 'DO CONSELHO DE ALIMENTAÇÃO ESCOLAR\n '
                           ...
                           + '\n§2º Quando do exercício das atividades do CAE, previstos no art. 19 da Lei nº 11.947/2009 e art. 35 desta Resolução, recomenda- se a liberação dos servidores públicos para exercer as suas atividades no Conselho, de acordo com o Plano de Ação elaborado pelo CAE, sem prejuízo das suas funções profissionais.\n '
...
export const CHAPTER_VIII = 'DA EXECUÇÃO DOS RECURSOS FINANCEIROS DO PROGRAMA\n '
                            + '\nSeção I\n '
                            + '\nDa Transferência, Operacionalização e Movimentação\n '
                            + '\nArt. 38 O FNDE transferirá recursos financeiros de forma automática, sem necessidade de convênio, ajuste, acordo, contrato ou instrumento congênere, nos termos do disposto na Lei nº 11.947/2009, para aquisição exclusiva de gêneros alimentícios, processando- se da seguinte forma:\n '
                            ...
                            + '\nIII-A - para os estudantes contemplados no Programa de Fomento às Escolas de Ensino Médio em Tempo Integral, haverá complementação financeira de forma a totalizar o valor per capita de R$ 2,00 (dois reais); (Acrescentado pela Resolução 11/2016/CD/FNDE/MEC)\n '
                            + '\nIV - para os alunos que frequentam, no contraturno, o AEE, o valor per capita será de R$ 0,53 (cinquenta e três centavos de real);  (Redação dada pela Resolução 1/2017/CD/FNDE/MEC)\n '
                            + '\n_____________________________________________________________________  Redações Anteriores\n '
                            ...
                            + '\nVII -   (Revogado pela Resolução 21/2014/CD/FNDE/MEC)\n '
                            + '\n_____________________________________________________________________  Redações Anteriores\n '
                            ...
                            + '\nXVII - a movimentação dos recursos financeiros realizar-seá exclusivamente por meio eletrônico, mediante crédito em conta corrente de titularidade dos fornecedores ou UEx., nos casos previstos no art. 8º;\n '
                            ...
                            + '\nI - se a devolução ocorrer no mesmo ano do repasse dos recursos às EEx., deverão ser utilizados os códigos 153173 no campo "Unidade Gestora", 15253 no campo "Gestão", 66666-1 no campo "Código de Recolhimento" e o código 212198001 no campo "Número de Referência"; ou\n '
                            ...
                            + '\nNota: Fica alterado o Código de Recolhimento 18858-1 para 18888-3, de acordo com a Resolução 7/2014/CD/FNDE/MEC '
                            + '_______________________________________________________________________________________________________\n '
...
export const CHAPTER_IX = 'DA PRESTAÇÃO DE CONTAS DO PROGRAMA\n '
                          ...
                          + '\n§7º Sanadas as ocorrências a que se refere o §5º deste artigo, o FNDE aprovará a prestação de contas da EEx.\n '
...
export const CHAPTER_X = 'DA FISCALIZAÇÃO DA EXECUÇÃO DO PROGRAMA\n '
...
export const CHAPTER_XI = 'DO MONITORAMENTO E DA AVALIAÇÃO DA EXECUÇÃO DO PROGRAMA\n '
...
export const CHAPTER_XII = 'DA DENÚNCIA\n '
                           ...
                           + '\nArt. 52 As denúncias destinadas ao FNDE deverão ser encaminhadas à sua Ouvidoria, no seguinte endereço: Setor Bancário Sul, Quadra 2, Bloco F, Edifício FNDE, Brasília, DF, CEP 70070- 929, ou para o endereço eletrônico ouvidoria@fnde.gov.br.\n '
...
export const CHAPTER_XIII = 'DO PROGRAMA MAIS EDUCAÇÃO\n '
...
export const CHAPTER_XIV = 'DAS DISPOSIÇÕES GERAIS\n '
