// Chapters of Legislation from Resolution n°1
export const RESOLUTION_1_DATE = 'RESOLUÇÃO Nº 1, DE 8 DE FEVEREIRO DE 2017';

export const LEGAL_FUNDAMENTATION = 'Constituição Federal de 1988, arts. 205, 208 e 211;\n '
                                    ...
                                    + '\nResolução CD/FNDE nº 5, de 25 de outubro de 2016.\n '
...
export const ARTICLE_1 = 'A necessidade de recomposição do poder aquisitivo do repasse per capita do Programa, resolve, ad referendum:\n'
...
export const ARTICLE_2 = 'Art. 2º Esta Resolução entra em vigor a partir de sua publicação.\n '
                         + '\nMENDONÇA FILHO\n '
